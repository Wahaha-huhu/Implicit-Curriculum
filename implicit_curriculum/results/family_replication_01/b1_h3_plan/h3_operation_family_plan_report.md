...
- exclude_composites: `None`
- condition_set_for_script: `strong`

## Planned pairs
- row `0`: `A02_substitute` → `C00_reverse_then_substitute_02_05`; same-op=`U01_unrelated_substitute`, diff-op=`A03_copy`, fake=`K02_shortcut_for_A00_copy`, surface=`S01_surface_rotate`, source residual=5.001, positive-rate=1.000
- row `1`: `A05_substitute` → `C00_reverse_then_substitute_02_05`; same-op=`U01_unrelated_substitute`, diff-op=`A03_copy`, fake=`K02_shortcut_for_A00_copy`, surface=`S01_surface_rotate`, source residual=5.001, positive-rate=1.000
