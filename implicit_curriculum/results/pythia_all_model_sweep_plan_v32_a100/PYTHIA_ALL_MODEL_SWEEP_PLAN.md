...
- `results/pythia_all_model_sweep_plan_v32_a100/run_mid_full_n64.sh`: full n=64 run for `EleutherAI/pythia-1b, EleutherAI/pythia-1.4b`.
- `results/pythia_all_model_sweep_plan_v32_a100/run_large_smoke_n16.sh`: large-model smoke n=16 run for `EleutherAI/pythia-2.8b, EleutherAI/pythia-6.9b, EleutherAI/pythia-12b`.
- `results/pythia_all_model_sweep_plan_v32_a100/recommended_pythia_all_model_synthesis.sh`: synthesize mid-full, large-smoke, and all available runs.
