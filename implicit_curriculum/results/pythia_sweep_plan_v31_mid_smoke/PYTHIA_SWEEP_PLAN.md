...
- models: `EleutherAI/pythia-1b, EleutherAI/pythia-1.4b`
- revisions: `step0, step10000, step143000`
- max_examples_per_slice: `64`
- planned runs: `2`

## Planned runs
- `pythia-1b_n64`: model=`EleutherAI/pythia-1b`, n_examples_per_slice=`64`, output=`results/pythia_model_sweep_v31_mid_smoke/pythia-1b_n64`
- `pythia-1.4b_n64`: model=`EleutherAI/pythia-1.4b`, n_examples_per_slice=`64`, output=`results/pythia_model_sweep_v31_mid_smoke/pythia-1.4b_n64`
